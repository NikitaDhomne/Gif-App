class ChildrenpackStickersModel {
  List<Data>? data;
  Pagination? pagination;
  Meta? meta;

  ChildrenpackStickersModel({this.data, this.pagination, this.meta});

  ChildrenpackStickersModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json["short_display_name"] is String) {
      shortDisplayName = json["short_display_name"];
    }
    if (json["description"] is String) {
      description = json["description"];
    }
    if (json["has_children"] is bool) {
      hasChildren = json["has_children"];
    }
    if (json["featured_gif"] is Map) {
      featuredGif = json["featured_gif"] == null
          ? null
          : FeaturedGif.fromJson(json["featured_gif"]);
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["short_display_name"] = shortDisplayName;
    _data["description"] = description;
    _data["has_children"] = hasChildren;
    if (featuredGif != null) {
      _data["featured_gif"] = featuredGif?.toJson();
    }
...
class FeaturedGif {
  ...
  FeaturedGif.fromJson(Map<String, dynamic> json) {
    if (json["type"] is String) {
      type = json["type"];
    }
