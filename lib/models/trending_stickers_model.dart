...
class TrendingStickersModel {
  List<Data>? data;
  Pagination? pagination;
  Meta? meta;

  TrendingStickersModel({this.data, this.pagination, this.meta});

  TrendingStickersModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data({this.type, this.id, this.url, this.slug, this.bitlyGifUrl, this.bitlyUrl, this.embedUrl, this.username, this.source, this.title, this.rating, this.contentUrl, this.sourceTld, this.sourcePostUrl, this.isSticker, this.importDatetime, this.trendingDatetime, this.images, this.user, this.analyticsResponsePayload, this.analytics});
...
class User {
  ...
  User({this.avatarUrl, this.bannerImage, this.bannerUrl, this.profileUrl, this.username, this.displayName, this.description, this.instagramUrl, this.websiteUrl, this.isVerified});

  User.fromJson(Map<String, dynamic> json) {
    if(json["avatar_url"] is String) {
      avatarUrl = json["avatar_url"];
    }
    if(json["banner_image"] is String) {
      bannerImage = json["banner_image"];
    }
    if(json["banner_url"] is String) {
      bannerUrl = json["banner_url"];
    }
    if(json["profile_url"] is String) {
