class EmogiModel {
  ...
  EmogiModel({this.data, this.pagination, this.meta});

  EmogiModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["emoji_group_id"] = emojiGroupId;
    _data["variation"] = variation;
    _data["variation_count"] = variationCount;
...
class Analytics {
  ...
  Analytics.fromJson(Map<String, dynamic> json) {
    ...
    if (json["onstart"] is Map) {
      onstart =
          json["onstart"] == null ? null : Onstart.fromJson(json["onstart"]);
    }
  }
...
class Onstart {
  ...
  Onstart.fromJson(Map<String, dynamic> json) {
    if (json["url"] is String) {
      url = json["url"];
    }
  }
